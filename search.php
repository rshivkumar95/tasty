...
<div style="margin-top: 20px;"><h2 style="display: inline-block;
    ...
    margin: 0;
    color: #333;
    text-transform: uppercase;">Restaurants at </h2></div>
<hr>
<?php
   ...
   if($by=='any')
   {
    ...
    //echo $key;
       $query="SELECT * FROM `restaurant_info` WHERE Restaurant_Name='$key' or landmark='$key' or Restaurant_Address='$key' ORDER BY `Rating`";

   }
   if($by=='landmark')
   {
   	   $query="SELECT * FROM `restaurant_info` WHERE landmark='$key' ORDER BY `Rating`";
   }
