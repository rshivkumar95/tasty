...
<!-- /Block categories module -->
 ...
 <div class="col-lg-12 col-sm-12">
   ...
   <h3>RETURN, REFUND &amp; CANCELLATION POLICY</h3>
   <p align="justify">LAST REVISION: [23/02/2017]<br>

PLEASE READ THIS RETURN, REFUND &amp; CANCELLATION POLICY

CAREFULLY. BY USING THIS WEBSITE OR ORDERING PRODUCTS FROM

THIS WEBSITE YOU AGREE TO BE BOUND BY ALL OF THE TERMS AND

CONDITIONS OF THIS AGREEMENT.<br><br>

Return
<br><br>
1. The food items purchased are not at all returnable after purchase. The customer

should ensure before ordering on website.

Cancellation<br><br>

2. Once the order is placed, it can not be cancelled.<br><br>

3. But due to unavailability of product or operational constraints, we may cancel the

order under intimation to the customer.

Refunds<br><br>

4. As there is no return, no cancellation policy, the refunds of items cancelled from

our side will be refunded back to you within 15 days through our payment
