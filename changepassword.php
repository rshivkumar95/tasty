...
?>
 ...
 <div class="center-block container row" style="padding: 20px;">
   <h4>Hello, <strong><?php echo $data['CustomerName']; ?></strong></h4>

 <div class="col-lg-9 col-sm-12">
   
   <h3>Change Password</h3>

     <div class="row" style="background-color: #f5f5f5;padding: 20px;border-radius: 10px;">
     	
     	<div class="col-sm-6" style="background-color: #fff;padding: 10px;border-radius: 10px;">
     	    ...
     	    <form>
     	       ...
     	       <div class="form-group">
     	         <label for="newpasswordagain">Re-Enter New Password</label>
     	       	  <input type="Password" name="newpasswordagain" id="newpasswordagain" placeholder="Re-Enter New Password" class="form-control">
     	       </div>
     	       <a class="btn btn-warning" onclick="change();" style="float: right;">CHANGE</a>
     	...
     	<div class="col-sm-6">
     	  ...
     	  <img src="img/lock.png" class="img-responsive" style="width:80%;">
   ...
   function change()
           {
              ...
              var newpass1=$('#newpasswordagain').val();

              if(old=="" || newpass=="" || newpass1=="")
              {
                         ...
                         success:function(result)//we got the response
                         {
                           //alert(result);
                            var result1=$.trim(result);
                             if(result1==='Old Password Not Match')
                             {
	...
	function WishlistCart($id)
	{
		$.ajax({
                         ...
                         success:function(result)//we got the response
                         {
                         	...
                         	{
                         		if(confirm("Wishlist only available for registered User | Register/Log In Now ?"))
                         		{
	...
	function addtocart($id)
	{
		...
		$.ajax({
                         ...
                         success:function(result)//we got the response
                         {
                         	...
                         	{
                         		if(confirm("You are Adding Item From Different Restaurant Will Cause You Separate Delivery Charge| Are you sure to continue ?"))
                         		{
                         			addtocart1($id);
                         		}
                         	}
