...
<!-- /Block categories module -->
   ...
   <h4>Hello, <strong>Shivkumar Rathod</strong></h4>
 ...
 <div class="col-lg-9 col-sm-12">
   ...
   <h3>Your Reviews</h3>
     ...
     <div class="row" style="background-color: #f5f5f5;padding: 20px;border-radius: 10px;">
     	...
     	<div class="col-sm-12" style="background-color: #fff;padding: 10px;border-radius: 10px;">

     	    <!--form>
     	       
     	       <div class="form-group">
			    <label for="orderid">Choose Order ID</label>
			    <select class="form-control" id="orderid">
			        
			      
			      <?php
			          $email=$_SESSION['email'];
                         $query="SELECT * FROM `orders` WHERE `custID`='$email'";
			      ...
			      <option><?php echo $obj['Order_Id']; ?></option>
			      <?php
                       }
			      ?>
			    </select>
     	    ...
     	    <!--div>
     	          ...
     	          <h3>Order Status:<span id="orderStatus" style="color: green;">Delivered</span></h3>
     	          <div class="row">
                        <div class="col-sm-3">
                        	Order ID:
                        	<br>
