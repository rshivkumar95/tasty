	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-4 col-xs-5 col-md-3 col-sm-4">' + $(element).find('.left-block').html() + '</div>';
				html += '<div class="right-block col-xs-8 col-xs-7 col-md-9">';
					html +='<div class="right-block-inner col-md-8">';
					...
					html +='</div>'
					html +='<div class="actions-inner col-md-4">';
