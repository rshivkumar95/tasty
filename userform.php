...
<!-- Mirrored from demo.posthemes.com/pos_zodiac/food/en/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2016 06:16:09 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
		<meta charset="utf-8"/>
		<title>Pos Zodiac Food</title>
		...
		<link rel="icon" type="image/vnd.microsoft.icon" href="http://demo.posthemes.com/pos_zodiac/food/img/favicon.ico?1406337085" />
		<link rel="shortcut icon" type="image/x-icon" href="http://demo.posthemes.com/pos_zodiac/food/img/favicon.ico?1406337085" />
			...
			<link rel="stylesheet" href="../themes/pos_zodiac_food/css/product_list.css" type="text/css" media="all" />
			...
			<link rel="stylesheet" href="../themes/pos_zodiac_food/css/modules/blockcurrencies/blockcurrencies.css" type="text/css" media="all" />
			...
			<link rel="stylesheet" href="../themes/pos_zodiac_food/css/modules/blockwishlist/blockwishlist.css" type="text/css" media="all" />
			<link rel="stylesheet" href="../themes/pos_zodiac_food/css/modules/productcomments/productcomments.css" type="text/css" media="all" />
			...
			<link rel="stylesheet" href="../themes/pos_zodiac_food/css/modules/posnewproduct/css/new.css" type="text/css" media="all" />
...
.rating > input:checked ~ label:hover ~ label { color: #FFED85;  } 
	...
	<body id="index" class="index hide-left-column lang_en">
			...
			<div class="header-container">
				<header id="header">
					<div class="nav" style="background-color: #e52f2f; box-shadow: 2px 2px 2px #232323;">
						<div class="container">
							<div class="row">
...
<form>
  <input style="box-shadow: 2px 2px 2px;" type="text" name="search" placeholder="Search..">
</form>
...
<div class="col-xs-12 col-sm-6 col-lg-6 col-md-4">
			...
			<form action="http://demo.posthemes.com/pos_zodiac/food/en/login" method="post" id="create-account_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<div class="form-group">
						...
						<input  type="text" class="is_required validate account_input form-control" data-validate="isEmail" id="sp2" name="email_create" value="">
					</div>
					<div class="form-group">
						<label for="email_create">Name</label>
						<input type="text" class="is_required validate account_input form-control" data-validate="isEmail" id="sp2" name="email_create" value="">
					</div>
					<div class="form-group">
						<label for="email_create">Mobile-No</label>
						<input type="text" class="is_required validate account_input form-control" data-validate="isEmail" id="sp2" name="email_create" value="">
					</div>
					<div class="form-group">
					...
					<div class="submit">
						<input type="hidden" class="hidden" name="back" value="my-account">						<button class="btn btn-default button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate" style="background-color: #e52f2f; border-color: none; ">
							<span>
			...
			<form  action="http://demo.posthemes.com/pos_zodiac/food/en/login" method="post" id="login_form" class="box">
				...
				<div class="form_content clearfix">
					<div class="form-group">
						...
						<input id="sp2" class="is_required validate account_input form-control" data-validate="isEmail" type="text" id="email" name="email" value="">
					</div>
					<div class="form-group">
					...
					<p class="submit">
						<input id="sp2" type="hidden" class="hidden" name="back" value="">						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium">
							<span>
...
<div class="" style="margin-top: 10px; margin-bottom: 10px; width: 100%">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="6.jpg" alt="Chania" width="460" height="345">
      </div>
...
<script type="text/javascript" src="../themes/pos_zodiac_food/js/modules/blockwishlist/js/ajax-wishlist.js"></script>
