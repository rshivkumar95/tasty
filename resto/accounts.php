...
<body>
    ...
    <div id="main">
        ...
        <div class="wrapper">
            ...
            <section id="content" style="background-image:url('images/biryani.jpg');min-height:650px;">
               ...
               <div class="row" >
                   ...
                   <div class="col s12 l6 push-l3">
                      <ul id="projects-collection" class="collection" style="border-radius:25px;">
										...
										<h4 style="color:red;"><center>CHANGE PASSWORD</center></h4>
                                        </li>
                                        
                                   
                                    <li class="collection-item">
                                        <div class="row">
                                            <form id="form" name="form" method="POST" action="accounts.php" enctype="multipart/form-data">
                                              <div class="row">
                                                <div class="input-field col s12 l12">
                                                  <i class="mdi-action-lock-open prefix"></i>
                                                  <input id="oldPass" name="oldPass" type="password" class="validate" required="">
                                                ...
                                                <div class="input-field col s12 l12">
                                                  ...
                                                  <input id="newPass1" name="oldPass" type="password" class="validate" required="">
