    ...
    <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold active"><a href="reviews.php" class="waves-effect waves-cyan"><i class="mdi-action-thumbs-up-down"></i>REVIEWS</a>
                </li>
                            ...
                            while ($obj = mysql_fetch_array($result))
                            {
                                ...
                                <div class="col s12 l12">
                                    ...
                                    <div class="row hoverable" style="padding: 15px;border-radius:25px;">
                                        ...
                                        <div class="col s12 l4">
                                            <h6><strong><?php echo $obj['review']; ?></strong></h6>
                                        </div>
                                        <div class="col s12 l4">
                                            <?php
                                            $rating=$obj['rating'];
