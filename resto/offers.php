                   ...
                   <div class="col s12 l12">
                      <ul id="projects-collection" class="collection">
                                    <li class="collection-item avatar">
                                        ...
                                        <span class="collection-header">Add Offer</span>
                                        <p>Add New Offer</p>
                                        
                                    </li>
                                    <li class="collection-item">
                                        <div class="row">
                                            <form id="form" name="form" method="POST" action="addnewoffer.php" enctype="multipart/form-data">
                                              <div class="row">
                   ...
                   <div id="restaurant-data" class="container">
                      ...
                      <!-- CUSTOM CREATED BLOCK -->
                          <div class="col s12 l12">
                              ...
                              <div class="row hoverable" style="padding: 15px;border:1px solid black;border-radius: 5px 5px 5px 5px;">
                                  <div class="col s12 l4">
                                        <h6><strong><?php echo $obj['OfferName']; ?></strong></h6>
                                  </div>
