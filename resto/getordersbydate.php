...
$date=$_POST['date'];
$query="SELECT * from orders WHERE orders.Order_Id=ANY (SELECT orderrest.orderID from orderrest WHERE orderrest.restID='$restID') and orders.OrderDate='$date'  ORDER BY orders.Order_Id DESC";
//

$result=mysql_query($query);

$_SESSION['totalorder']=mysql_num_rows($result);
if($_SESSION['totalorder']>0)
{
	...
	while($data=mysql_fetch_array($result))
		{
		    ...
		    $orderID=$data['Order_Id'];
		       $query5="SELECT * FROM `customers` WHERE `Email`='$custID'";
		       ...
		       $data2=mysql_fetch_assoc($result5);
                ...
                <div style="padding:10px;background: rgba(128, 128, 128, 0.54);">
	                            ...
	                            <div class="row">
									  		 ...
									  		 <div class="col s6 m6 l6">
									  		      <b>Customer Name :</b><?php echo $data2['CustomerName']; ?>
									  		 </div>
									  		 <div class="col s6 m6 l6">
									  		      <b>Mobile No :</b><?php echo $data2['MobileNo'];; ?>
									  		 </div> 
									  		 <div class="col s6 m6 l6">
									  		      <b>Ship To :</b><?php
