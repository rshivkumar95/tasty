...
<!-- /Block categories module -->
 ...
 <div class="col-lg-12 col-sm-12">
   ...
   <div class="row">
   	   <div class="col-sm-6 col-sms-12 col-md-6"><br>
   	   	    <form action="sendcontact.php" method="POST">
   	   	           ...
   	   	           <div class="form-group">
   	   	             ...
   	   	             <input type="submit" name="submit" class="btn btn-danger" value="SEND" style="float: right;">
   	   ...
   	   <div class="col-sm-6 col-sms-12 col-md-6"><br>
   	       <h3>Contact Details</h3>
   	   		<b><div class="address">Address: Adbhut Innovation, Vishnu Nagar, Nanded.</div><br>
										<div class="phone">Phone : 9168337195, 7972338117</div><br>
										<div class="mail">Email : adbhutinnovations@gmail.com </div></b>
   	   </div>
