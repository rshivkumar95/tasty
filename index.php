...
<!-- /Block categories module -->
						...
						<div class="nav-container visible-lg visible-md">
							<div class="">
								<div id="pt_custommenu" class="pt_custommenu">					   
								    <div id="pt_menu_home" class="pt_menu act"><div class="parentMenu"><a href="index.php"><span>Home</span></a></div></div>
									...
									<div class="flexslider ma-nivoslider">
						        		<div class="pos-loading"></div>
						            		<div id="pos-slideshow-home" class="slides">
									            <?php
									                 $query="SELECT * FROM `ads` WHERE `ADType`='Banner' AND `ADStatus`='Active' ORDER BY `ADPriority` DESC";
									            ...
									            ?>
						        			        <img style ="display:none" src="<?php echo $obj['ADImage']; ?>"  data-transition="boxRainReverse" data-thumb="<?php echo $obj['ADImage']; ?>"  alt="<?php echo $obj['ADTitle']; ?>" title="#htmlcaption3"  />
			...
			<div class="columns-container" style="padding: 20px;">
				<div id="columns" class="container">
				 ...
				 <form class="input_container1 text-center">
				    ...
				    <br><br><input type="text" id="search1" name="search1" placeholder="Enter Your Location" onkeyup="autocomplet1()" style="width:80%;margin-bottom: 0px;">
     	  	  ...
     	  	  <div class="banner-static-contain row">
     	  	  <h2 style="display: inline-block;font-family: 'Helvetica-Condensed-Black';font-size: 20px;margin: 0;color: #333;text-transform: uppercase;">Latest Offers</h2><hr>
					<div class="home-banner-static row text-center">


							<?php

									$query="SELECT * FROM `offers` ORDER BY RAND() LIMIT 3";
									$result=mysql_query($query);
									while ($obj = mysql_fetch_array($result)) 
									{
							?>
										<div class="banner-box banner-box1 col-md-4 col-sm-4 col-xs-12">
											<div class="" style="padding-top: 10px;">
												<a onclick="viewoffer(<?php echo $obj['OfferID']; ?>)">
												<img src="<?php echo $obj['OfferImage']; ?>" alt="" style="width:100%; border-radius: 10px;
    border: 1px solid red;"/><h4 class="panel footer-text-new" style="background-color: #232323;font-size:15px;padding: 10px;"><?php echo $obj['OfferName']; ?></h4></a>
											</div>
										</div>
							...
							?>
									<div style="float:right;margin-right:50px;margin-top: 20px; ">
										<a class="btn btn-danger" href="offers.php" style="text-align: right;">View More</a>
									</div>
					</div>
			  </div>

			  <div class="row">
                    <div style="margin-top: 20px;"><h2 style="display: inline-block;font-family: 'Helvetica-Condensed-Black';font-size: 20px;margin: 0;color: #333;text-transform: uppercase;">Featured Products</h2></div><hr>  
                 			<ul class="product_list grid">
                    				<?php

										$query="SELECT * FROM `restaurant_menu` ORDER BY RAND() LIMIT 8";
										$result=mysql_query($query);
										while ($obj = mysql_fetch_array($result)) 
										    {
									?>
													...
													<div class="product-container" itemscope="" >
														...
														<div class="right-block">
															...
															<div class="button-container">
																<a href="<?php echo 'restaurant.php?restaurant='.$obj['Restaurant_Id']; ?>" class="button ajax_add_to_cart_button btn btn-default"  rel="nofollow" title="View More Items in Above Restaurant" >
																				      <span>View More</span>
																</a>
															</div>
					...
					<div style="margin-top: 20px;"><h2 style="display: inline-block;font-family: 'Helvetica-Condensed-Black';font-size: 20px;margin: 0;color: #333;text-transform: uppercase;">Famous Restaurants</h2></div>
						<hr>
						<?php

													$query="SELECT * FROM `restaurant_info` ORDER BY `Rating` DESC LIMIT 6";
													$result=mysql_query($query);
													$i=1;
													while ($obj = mysql_fetch_array($result)) 
													{
...
<div id="best-sellers_block_right" class="block products_block">
	...
	<div class="block_content">
			...
			<?php
     	            ...
     	            $query="SELECT * FROM `restaurant_menu` ORDER BY RAND() LIMIT 10";
					$result=mysql_query($query);
											                 $i=1;
											                 while ($obj = mysql_fetch_array($result)) {
