...
<ul id="header_links">
		...
		<li><a class="link-myaccount" href="login.html" title="My account">My account</a></li>
...
<!-- /Steps -->
	...
	<p style="display:none" id="emptyCartWarning" class="alert alert-warning">Your shopping cart is empty.</p>
			...
			<a class="cart_last_product_img" href="pizza/13-consectetuer.html">
				<img src="img/consectetuer.jpg" alt="Breakfast Potato">
			</a>
			<div class="cart_last_product_content">
				<p class="product-name">
					<a href="pizza/13-consectetuer.html">
						Breakfast Potato
					</a>
				</p>
							</div>
	...
	<div id="order-detail-content" class="table_block table-responsive">
		<table id="cart_summary" class="table table-bordered">
			...
			<tfoot>
							...
							<td colspan="2" class="price" id="total_product">216,00 €</td>
						</tr>
													<tr style="display: none;">
					<td colspan="3" class="text-right">
													Total gift wrapping (tax incl.):											</td>
					...
					<td colspan="3" class="total_price_container text-right">
						<span>Total</span>
							...
							<span id="total_price">216,00 €</span>
						</td>
									</tr>
			</tfoot>
			<tbody>
	...
	<td class="cart_product">
		<a href="pizza/13-consectetuer.html"><img src="img/consectetuer.jpg" alt="Breakfast Potato" width="98" height="98"></a>
	</td>
	<td class="cart_description">
		<p class="product-name"><a href="pizza/13-consectetuer.html">Breakfast Potato</a></p>
        <small class="cart_ref">SKU : demo_13</small>			</td>
	...
	<td class="cart_quantity text-center">
			...
			<div style="margin:  8px;">	<div type="button" class="btn btn-primary col-md-offset-2" style="border-radius: 8px; background-color: #e52f2f;"><div id="javas_button1">1</div></div></div>
				<div class="btn-group row">
    <button type="button" class="btn btn-primary" style="border-radius: 8px; background-color: white; color: #232323;" onclick="clickCounter_but('javas_button1')" id="add_button1">+</button>
    
    <button class="btn btn-primary" style="border-radius: 8px; background-color: white; color: #232323; margin: 0px;" onclick="clickCounter_nev('javas_button1')" id="sub_button1">-</button>
  </div>
						</td>
	<td class="cart_total" data-title="Total">
		<span class="price" id="total_product_price_13_0_0">
												216,00 €									</span>
	</td>
			<td class="cart_delete text-center" data-title="Delete">
					<div>
				<a rel="nofollow" title="Delete" class="cart_quantity_delete" id="13_0_0_0" href="ordera1f3.html?delete=1&amp;id_product=13&amp;ipa=0&amp;id_address_delivery=0&amp;token=fe364affbd7a5cead98d60a32f4c9470"><i class="icon-trash"></i></a>
			</div>
				</td>
	</tr>
	...
	<p class="cart_navigation clearfix">
					<a href="loginc89e.html?step=1" class="button-exclusive btn-default standard-checkout pull-right btn" title="Proceed to checkout" style="">
				<span>Proceed to checkout  <i class="icon-chevron-right right"></i></span>
			</a>
				<a href="index.html" class="button-exclusive btn btn-default" title="Continue shopping">
