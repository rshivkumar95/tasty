...
<div class="nav-container visible-lg visible-md">
	<div class="">
		<div id="pt_custommenu" class="pt_custommenu">
		    ...
		    <div id="pt_menu_home" class="pt_menu act"><div class="parentMenu"><a href="index.htmls"><span>Home</span></a></div></div><div id="pt_menu111" class="pt_menu nav-1">
...
<div id="ddd1" class="dropdown-content">
    <a id="dddd" href="chinese.html">Chinese</a>
    <a id="dddd" href="south-indian.html">South Indian</a>
  </div>
</div>
...
<div class="clearBoth"></div>
	...
	<div class="flexslider ma-nivoslider">
        <div class="pos-loading"></div>
			...
			<div align="center" style="border: 2px #232323 solid; margin-top: 50px; margin-bottom: 50px; border-radius: 12px; background: url(img/biryani.jpg); box-shadow: 1px 1px 1px;" class="container">
<h1 style="color: white;">Rate our Product!</h1>
<div class="row-fluid " style="margin-bottom:60px; padding-bottom: 60px; ">
<div class="col-lg-12 col-sm-12">
<div class="row">
<div class="col-lg-12 col-sm-12 container">
<h3>Enter your Review<br><p style="font-size: 12px;color: #222222;">Hi! Thank You for Choosing us.Your feedback is important for us.</p></h3>
<div class="pull-right col-lg-4 glyphicon glyphicon-user "><a href="#" style="font-weight: 200;font-size: 18px;text-decoration: none;">Log-in!</a></div>
</div>
</div>
<br>
<div class="col-lg-12 col-sm-12 ">
<div class="input-field">
<textarea placeholder="Enter text here..." rows="4" id="textareanew" name="comment" form="usrform" style="border: black solid 2px; border-radius:5px; font-size: 20px;width: 60%; "></textarea>
</div>

<div class="row container">
<div class="col-lg-6 col-sm-12" style="padding-top: 35px;">
<button class="btn" id="sp1"><a href="#" style="text-decoration: none; color: white;"><h4>POST</h4></a></button>
</div>
<div class="col-lg-6 col-sm-12">

<fieldset class="rating" id="sp1">
<p style="color: white; font-size: 12px;">Rate here</p>
    <div class="radio" id="uniform-star5" style="display: none;"><span><input type="radio" id="star5" name="rating" value="5"></span></div><label class="full" for="star5" title="Awesome - 5 stars"></label>
    <div class="radio" id="uniform-star4half" style="display: none;"><span><input type="radio" id="star4half" name="rating" value="4 and a half"></span></div><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>
    <div class="radio" id="uniform-star4" style="display: none;"><span><input type="radio" id="star4" name="rating" value="4"></span></div><label class="full" for="star4" title="Pretty good - 4 stars"></label>
    <div class="radio" id="uniform-star3half" style="display: none;"><span><input type="radio" id="star3half" name="rating" value="3 and a half"></span></div><label class="half" for="star3half" title="Meh - 3.5 stars"></label>
    <div class="radio" id="uniform-star3" style="display: none;"><span><input type="radio" id="star3" name="rating" value="3"></span></div><label class="full" for="star3" title="Meh - 3 stars"></label>
    <div class="radio" id="uniform-star2half" style="display: none;"><span><input type="radio" id="star2half" name="rating" value="2 and a half"></span></div><label class="half" for="star2half" title="Kinda bad - 2.5 stars"></label>
    <div class="radio" id="uniform-star2" style="display: none;"><span><input type="radio" id="star2" name="rating" value="2"></span></div><label class="full" for="star2" title="Kinda bad - 2 stars"></label>
    <div class="radio" id="uniform-star1half" style="display: none;"><span><input type="radio" id="star1half" name="rating" value="1 and a half"></span></div><label class="half" for="star1half" title="Meh - 1.5 stars"></label>
    <div class="radio" id="uniform-star1" style="display: none;"><span><input type="radio" id="star1" name="rating" value="1"></span></div><label class="full" for="star1" title="Sucks big time - 1 star"></label>
    <div class="radio" id="uniform-starhalf" style="display: none;"><span><input type="radio" id="starhalf" name="rating" value="half"></span></div><label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
</fieldset>
