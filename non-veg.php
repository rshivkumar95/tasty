						...
						<div class="nav-container visible-lg visible-md">
							<div class="">
								<div id="pt_custommenu" class="pt_custommenu">					   
								    ...
								    <div id="pt_menu112" class="pt_menu nav-2 act"><div class="parentMenu"><a href="non-veg.php"><span>Non-Veg</span></a></div></div>
...
<?php
							...
							$query="SELECT * from restaurant_info where restaurant_info.Restaurant_ID=ANY (SELECT restaurant_menu.Restaurant_Id from restaurant_menu WHERE restaurant_menu.Item_category='Non-Veg') order by restaurant_info.Rating";
...
<div id="best-sellers_block_right" class="block products_block">
	...
	<div class="block_content">
			...
			<?php
     	            ...
     	            $query="SELECT * FROM `restaurant_menu` where Item_category='Non-Veg' ORDER BY RAND() LIMIT 5";
					$result=mysql_query($query);
											                 $i=1;
											                 while ($obj = mysql_fetch_array($result)) {
