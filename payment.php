...
<!-- /Block categories module -->
          ...
          <div class="center-block container row" style="padding: 20px;">
               ...
               <div class="row" style="width:70%;margin: 0 auto;margin-bottom: 100px;margin-top: 100px;">
                       <div class="col-sm-6">
                            <a href="#" ><img src="img/payt.png" class="img-responsive" style="width:200px;float: right;"></a>
                       </div>
                       <div class="col-sm-6">
                          <a href="payumoney.php" title="Pay U Money"><img src="img/payu.jpg" class="img-responsive" style="width:200px;float: left;"></a>
                       </div>
